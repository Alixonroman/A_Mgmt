...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { address: @apartment.address, baths: @apartment.baths, beds: @apartment.beds, image: @apartment.image, sqf: @apartment.sqf } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, baths: @apartment.baths, beds: @apartment.beds, image: @apartment.image, sqf: @apartment.sqf } }
